...
class Settings(BaseSettings):
    ...
    USER_PATTERN_ENABLED: bool = True
    USER_PATTERN_CACHE_TTL_SECONDS: int = 90
    USER_PATTERN_MAX_MEMORY_ROWS: int = 80
    USER_PATTERN_MAX_QUERY_TERMS: int = 8
    USER_PATTERN_MIN_INTERACTIONS: int = 3
    COLLABORATION_ENABLED: bool = True
    COLLABORATION_MAX_WORKSPACES: int = 300
    COLLABORATION_MAX_EVENTS_PER_WORKSPACE: int = 500
    COLLABORATION_WORKSPACE_TTL_SECONDS: int = 7200
    COLLABORATION_PRESENCE_TTL_SECONDS: int = 90
    COLLABORATION_POLL_MAX_EVENTS: int = 100
    COLLAB_SOCKET_PATH: str = "/realtime/socket.io"
    COLLAB_SOCKET_MAX_BUFFER_BYTES: int = 262144
    COLLAB_SOCKET_MAX_ROOM_UPDATES: int = 600
    COLLAB_SOCKET_MAX_JOIN_UPDATES: int = 240
    COLLAB_SOCKET_REPLAY_TTL_SECONDS: int = 14400
